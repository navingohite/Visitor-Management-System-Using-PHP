...
if (strlen($_SESSION['navingohite'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $navingohite = $_SESSION['navingohite'];
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Add New Visitor </h4>
                                    <ol class="breadcrumb p-0 m-0">
                                        <li>
                                            <a href="#">New Visitor</a>
                                        </li>
                                        <li class="active">
                                            Add New Visitor
                                        </li>
                                    ...
                                    <div class="">
                                        <form name="addpost" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group m-b-20">
                                                ...
                                                <input type="text" class="form-control" id="posttitle" name="mobilenumber" placeholder="Enter Phone Number" required>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="card-box">
                                                        ...
                                                        <textarea class="form-control" cols="30" rows="5" name="address" required></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group m-b-20">
                                                <label for="exampleInputEmail1">Meeting With</label>
                                                <input type="text" class="form-control" id="posttitle" name="whomtomeet" placeholder="" required>
                                            </div>
                                            <div class="form-group m-b-20">
                                                <label for="exampleInputEmail1">Department</label>
                                                <input type="text" class="form-control" id="posttitle" name="department" placeholder="" required>
                                            </div>
                                            <div class="form-group m-b-20">
                                                <label for="exampleInputEmail1">Purpose</label>
                                                <input type="text" class="form-control" id="posttitle" name="reasontomeet" placeholder="" required>
                                            </div>


                                            <button type="submit" name="submit" class="btn btn-primary waves-effect waves-light">Add Visitor</button>
                                        </form>
                                    </div>
                                </div> <!-- end p-20 -->
                            </div> <!-- end col -->
