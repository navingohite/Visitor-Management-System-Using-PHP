...
! function($) {
	...
	FlotChart.prototype.init = function() {
		...
		var pcolors = ['#232b2b', '#232b2b','#232b2b'];
		...
		var colors = ['#232b2b', '#232b2b', "#232b2b", "#f9c851"];
		...
		this.createStackBarGraph("#ordered-bars-chart", stack_ticks, ['#26a69a', '#232b2b', "#ebeff2"], ds);
		...
		this.createLineGraph("#line-chart-alt", line_ticks, ["#232b2b", "#232b2b"], line_data);
	},
