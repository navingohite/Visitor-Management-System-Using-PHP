...
!function($) {
    ...
    MorrisCharts.prototype.init = function() {
        ...
        this.createLineChart('morris-line-example', $data, 'y', ['a', 'b'], ['Series A', 'Series B'],['0.1'],['#ffffff'],['#999999'], ['#232b2b', '#232b2b']);
        ...
        this.createBarChart('morris-bar-example', $barData, 'y', ['a', 'b', 'c'], ['Series A', 'Series B', 'Series C'], ['#3ac9d6', '#ff9800', "#232b2b"]);
        ...
        this.createDonutChart('morris-donut-example', $donutData, ['#232b2b', '#ebeff2', "#3ac9d6"]);
    },
    //init
