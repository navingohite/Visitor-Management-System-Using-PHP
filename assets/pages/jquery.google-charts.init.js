...
! function($) {
    ...
    GoogleChart.prototype.init = function () {
        ...
        $this.createLineChart($('#line-chart')[0], common_data, 'Sales and Expenses', ['#232b2b', '#232b2b']);


        //creating area chart using same data
        $this.createAreaChart($('#area-chart')[0], common_data, 'Sales and Expenses', ['#232b2b', '#232b2b']);
        ...
        $this.createColumnChart($('#column-chart')[0], column_data, 'Sales and Expenses', ['#232b2b', '#232b2b', '#3ac9d6']);
        ...
        $this.createBarChart($('#bar-chart')[0], bar_data, ['#232b2b', '#232b2b']);
        ...
        $this.createColumnStackChart($('#column-stacked-chart')[0], column_stacked_data, 'Sales and Expenses', ['#232b2b', '#232b2b', '#f9c851', '#232b2b', '#6b5fb5', '#3ac9d6']);
        ...
        $this.createBarStackChart($('#bar-stacked-chart')[0], bar_stacked_data, ['#232b2b', '#232b2b', '#f9c851', '#232b2b', '#6b5fb5', '#3ac9d6']);
        ...
        $this.createPieChart($('#pie-chart')[0], pie_data, ['#232b2b', '#232b2b', '#f9c851', '#232b2b', '#6b5fb5'], false, false);


        //creating donut chart
        $this.createDonutChart($('#donut-chart')[0], pie_data, ['#232b2b', '#232b2b', '#f9c851', '#232b2b', '#6b5fb5']);

        //creating 3d pie chart
        $this.createPieChart($('#pie-3d-chart')[0], pie_data, ['#232b2b', '#232b2b', '#f9c851', '#232b2b', '#6b5fb5'], true, false);
        ...
        $this.createPieChart($('#3d-exploded-chart')[0], sliced_Data, ['#232b2b', '#232b2b', '#f9c851', '#232b2b', '#6b5fb5'], true, true);
